 ...
 *
 * Original Author: Titon Barua <titanix88@gmail.com>
 *
 ...
 * Modified Date: August 21, 2013 by Roger MacRae
 */
...
class AmazonSES
{
    ...
    ($query) {
        ...
        $tmpar = explode('<', $response, 2);
        $response_http_headers = trim($tmpar[0]);
        $response_http_headers = substr($response_http_headers, strripos($response_http_headers, 'HTTP'));
        $response_content = trim( '<' . $tmpar[1]);
